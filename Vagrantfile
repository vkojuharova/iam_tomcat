...
#    virtualbox.customize ["modifyvm", :id, "--natdnshostresolver1", "on"]
  ...
  config.vm.provision :puppet do |puppet|
    ...
    puppet.facter = {
          ...
          "datasource_url"      => "jdbc:postgresql://10.38.1.81:5432/iddbpoc1",
          "datasource_username" => "adminappaccess",
          "datasource_password" => "2orange4me",
          "datasource_dialect"  => "org.hibernate.dialect.PostgreSQL82Dialect",
          "datasource_database" => "POSTGRESQL",
          "datasource_query"    => "select version()",
    }
...
#    puppet.options        = "--verbose --debug --modulepath /vagrant/resources/modules"
